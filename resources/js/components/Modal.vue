    ...
    <div>
        ...
        <div class="modal
         z-50 fixed w-full h-full top-0 left-0 flex items-center justify-center">
            ...
            <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white rounded shadow-lg modal-container md:max-w-xl">
                <div
                ...
                <div class="p-8 text-left modal-content">
                    ...
                    <div class="flex items-center justify-between pb-3">
                        <div class="z-50 cursor-pointer modal-close ml-auto" @click="closeModal">
                    ...
                    <slot name="modal-content" :onClose="closeModal"/>
