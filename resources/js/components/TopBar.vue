<template>
    <header class="flex items-center justify-between px-4 h-14 bg-white border-b-4 border-indigo-600">
        <div class="flex items-center">
            <button @click="toggleSideBar" class="text-gray-500 focus:outline-none lg:hidden">
                <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 6H20M4 12H20M4 18H11" stroke="#4f46e5" stroke-width="2" stroke-linecap="round"
                ...
                <transition enter-active-class="transition duration-150 ease-out transform"
                    ...
                    <div v-show="dropdownOpen"
                        ...
                        <button type="button" @click.prevent="logout"
                            class="block text-start w-full px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Log
                            out</button>
                    </div>
                </transition>
            </div>
